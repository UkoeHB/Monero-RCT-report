...
Formally, the positive modulus is here defined for $c = a \pmod b$ as $a=bx+c$, where $0\leq{c}<{b}$ and $x$ is a signed integer which gets discarded ($b$ is a positive integer).
