...
\bigskip
{\par\centering \textsc{\LARGE Опубликовано 4 апреля 2004 г. (v2.0.0)}\par}
%{\par\centering \textsc{\LARGE \today{}, Pre-Publication Draft 1.2.0}\par}
\bigskip
{\par\centering \textsc{\large koe\footnote{ukoe@protonmail.com}, Курт M. Алонсо\footnote{kurt@oktav.se}, Саранг Ноезер\footnote{sarang.noether@protonmail.com}}%\\(for questions and comments, please CC both authors)
\par}
\vfill{}
