...
\addto\captionsenglish{\renewcommand{\partname}{Часть}}
\addto\captionsenglish{\renewcommand{\appendixname}{Приложение}}
\addto\captionsenglish{\renewcommand{\appendixpagename}{Приложения}}
\addto\captionsenglish{\renewcommand{\appendixtocname}{Приложения}}
\addto\captionsenglish{\renewcommand{\bibname}{Список используемой литературы}}
...
\hypersetup{
    pdftitle = {Zero to Monero - Second Edition},
...
\vfill{}
{\par\centering \textsc{\huge От нуля к Monero: Второе издение}\par}
\bigskip \bigskip
{\par\centering \textsc{\LARGE Техническое руководство по приватной цифровой валюте для начинающих, любителей и экспертов}\par}
\bigskip
{\par\centering \textsc{\LARGE Опубликовано 4 апреля 2020 г. (v2.0.0)}\par}
%{\par\centering \textsc{\LARGE \today{}, Pre-Publication Draft 1.2.0}\par}
\bigskip
{\par\centering \textsc{\large koe\footnote{ukoe@protonmail.com}, Курт M. Алонсо\footnote{kurt@oktav.se}, Саранг Ноезер\footnote{sarang.noether@protonmail.com}\linebreak Перевод выполнен v1docq47\footnote{chiptune@protonmail.ch}}%\\(for questions and comments, please CC both authors)
\par}
\vfill{}
...
\textbf{Лицензия}: «От нуля к Monero: Второе издение» является общедоступной публикацией.
