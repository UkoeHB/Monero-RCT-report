...
A chave de ver é uma hash da chave privada do segredo partilhado entre o comprador e o vendedor. E a chave de encriptação das comunicações entre o comprador e o vendedor, é uma hash da chave de ver.
\footnote{Este mesmo processo aconteceria para uma multi-assinatura 1-de-2, o que exclui a necessidade de um moderador.} 
This same process would take place for 1-of-2 multisig, leaving out the moderator.}
