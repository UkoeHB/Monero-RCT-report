...
\bigskip \bigskip
{\par\centering \textsc{\LARGE Um Guía Técnico para uma moeda digital privada; para íniciados, amadores e especialistas .}\par}
\bigskip
{\par\centering \textsc{\LARGE Publicado a \today{} (v2.0.0)}\par}
...
{\par\centering \textsc{\large Traduzido por {\tt slave\_blocker} \footnote{dollner@gmx.de}}\par}
...
\textbf{Licença}: Zero a Monero: A segunda edição é liberta para o domínio público.
