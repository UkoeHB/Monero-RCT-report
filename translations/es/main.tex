...
\hypersetup{
    pdftitle = {De cero a Monero - Segunda Edición},
    pdfauthor = {koe, Kurt y Sarang}
}
...
\vfill{}
{\par\centering \textsc{\huge De cero a Monero: segunda edición}\par}
\bigskip \bigskip
{\par\centering \textsc{\LARGE Una guía técnica para una moneda digital privada; para principiantes, aficionados y especialistas.}\par}
\bigskip
{\par\centering \textsc{\LARGE Publicado el \today{} (v. 2.0.0)}\par}
\bigskip
...
{\par\centering \textsc{\large Traducido por Jorge Maldonado Ventura \footnote{jorgesumle@freakspot.net}}\par}
...
%\textbf{DRAFT INFORMATION}: This is just a draft, and may not always be available wherever it is currently hosted. The final version will be published at \url{https://web.getmonero.org/library/}.
  \textbf{Licencia}: \textit{De cero a Monero: segunda edición} está publicado en dominio público.
